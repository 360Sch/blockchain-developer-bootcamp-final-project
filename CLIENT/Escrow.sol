...
contract Escrow is Ownable {
    ...
    // TODO V2 transfer only property's deposit to owner if status.COMPLETED
    // Currently, transfer all ETH to owner because I don't want ETH to get stuck in the contract
    function sendEthToOwner() public payable onlyOwner {
